...
import showPasswordIcon from "../../../public/images/show-password-icon.svg";// "../../../public/images/show-password-icon.svg";
...
const ResetPasswordDataverse = ({ contactid, emailaddress1 }: InvitationType) => {
		...
		<>
			...
			<div className='absolute left-0 w-full h-full'>
				...
				>
					{/* Login Fields */}
					<div
						className="w-[30%] h-[100%] bg-[#E5E5E5] flex flex-col gap-1 justify-center items-center px-10"
					>
...
export default ResetPasswordDataverse